...
!**********************************************************************!
      ...
      integer, parameter :: sentinel = 1.0d4
      integer :: i, j, k, L
      ...
      do i=1, Nd
        ...
        do k=1, m
          ...
          dd = dvdf(j,k)          
          if (abs(dd) > 1.0d4) stop 'Large divided difference'
          do L=min(k,Lmax), 0, -1
            b(L) = b(L-1) + b(L) * Zk
...
!======================================================================!
      ...
      integer, parameter :: Nd = 30
      integer, parameter :: Lmax = 4
      integer, parameter :: m = 5
      integer :: i, L
      real(8) :: x(N), f(N), d(Nd), df(Nd,0:Lmax)
      character(len=20), parameter :: FM='(1x,f7.3,5f12.5)'
      ...
      call derive(N, Nd, Lmax, m, x, f, d, df) 
      write(6,FM) (d(i),(df(i,L), L=0,Lmax), i=1,Nd)
