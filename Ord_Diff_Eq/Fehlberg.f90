...
!----------------------------------------------------------------------!
     ...
     &                    beta61, beta62, beta63, beta64, beta65
      parameter(                                                       &
     &    w1 = 0.118518518518518d0, w2 =                0.0d0,         &
     &    w3 = 0.518986354775828d0, w4 =  0.506131490342016d0,         &
     &    w5 =            - 0.18d0, w6 = 0.0363636363636364d0)
...
!--------------------------------------------------------------------!
      ...
      integer :: NVAR, ALPHA
      real(8)  :: epsa, epsr
      parameter(NVAR=1, epsa=1.0d-300, epsr=epsilon(epsr), ALPHA=10)
      end module Com_var
...
!--------------------------------------------------------------------!
      ...
      select case(i)
          case(1);  Solu = exp(- dble(ALPHA) * x)
          case(2);  Solu = exp(- 10.0d0 * dble(ALPHA) * x)
      end select
